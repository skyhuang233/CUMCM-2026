...
\caption{组件变化相对对应 24h 基线的费用增量（元）}\label{tab:components}
...
\toprule
\rowcolor{cumcmgray} 组件变化 & \shortstack{问 2\\基线 13566396.26} & \shortstack{问 3\\基线 13024596.85} & \shortstack{问 4-2\\基线 14270606.71} & \shortstack{问 4-3\\基线 13716972.04} \\
\midrule
...
\bottomrule
\end{tabularx}
\par\vspace{3pt}{\footnotesize 费用增量为变体减基线，负值表示节省；“---”表示该分支不适用。}
\end{table}
